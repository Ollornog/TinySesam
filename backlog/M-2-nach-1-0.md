...
Mit [M-1](M-1-api-stabil-1-0.md) ist die Bibliothek auf PyPI ([ADR-6](ADR-6-pypi-veroeffentlichen.md)).
Das verschiebt den Massstab: Bis 1.0 war der Massstab „läuft im Repo", ab jetzt „kommt beim Fremden
richtig an". Hier sammeln sich die Punkte, die aus dieser Verschiebung folgen — Fristen des
