...
class TinySesamConfig:
    ...
    # (UTF-8, `#` am Zeilenanfang = Kommentar). Ergänzt die kleine eingebaute Liste — wer die
    # gängigen Leak-Listen (z.B. die 100 000 häufigsten) abgleichen will, legt sie hier ab.
    # Offline: TinySesam fragt keinen fremden Dienst. Leer = nur die eingebaute Liste.
