...
MESSAGES = {
    "en": {
        ...
        "api.name_invalid": 'This account name cannot be passed on — the operator has to rename the account',
        ...
        "api.password_long": 'Password too long (max. {n})',
        "api.password_weak": 'Password too easy to guess (known, trivial or derived from the account name)',
        ...
        "cancel": "Cancel",
        "logout": "Sign out",
        "logout.confirm": "Sign out of this account?",
        "acc.sessions_offer": "Your sign-in methods changed. Sign out all other sessions of this account now?",
        "acc.sessions_confirm": "Sign out all other sessions of this account now?",
        ...
        "err.directory_down": "Sign-in is currently unavailable: the user directory cannot be reached. Please try again later.",
        "err.pw_short": "Password too short (min. {n})",
        "err.pw_long": "Password too long (max. {n})",
        "err.pw_weak": "Password too easy to guess (known, trivial or derived from the account name)",
        "err.username_required": "Username required",
        "err.username_invalid": "Username contains characters that are not allowed",
        ...
        "magic.confirm_email_change": "Confirm new email address",
        # --- forgot / reset ---
        ...
        "acc.username_change": "Change username",
        "acc.email": "Email address",
        "acc.email_new": "New email address",
        "acc.email_change": "Change email address",
        ...
        "acc.recovery_left": "{n} recovery codes left",
        "acc.recovery_low": "Only {n} recovery codes left — generate new ones",
        ...
        "admin.f.admin": "Admin",
        "admin.btn.owner_on": "Make owner",
        "admin.btn.owner_off": "Remove owner",
        "admin.confirm.owner_on": "Make this account an owner? Owners cannot be deleted or disabled.",
        "admin.confirm.owner_off": "Remove the owner role from this account?",
        ...
        "admin.disabled_confirmation": "disabled (confirmation / app)",
    ...
    "de": {
        ...
        "api.name_invalid": 'Dieser Kontoname lässt sich nicht weitergeben — der Betreiber muss das Konto umbenennen',
        ...
        "api.password_long": 'Passwort zu lang (max. {n})',
        "api.password_weak": 'Passwort zu leicht zu erraten (bekannt, trivial oder aus dem Kontonamen)',
        ...
        "cancel": "Abbrechen",
        "logout": "Abmelden",
        "logout.confirm": "Von diesem Konto abmelden?",
        "acc.sessions_offer": "Deine Anmeldewege haben sich geändert. Jetzt alle anderen Sitzungen dieses Kontos beenden?",
        "acc.sessions_confirm": "Jetzt alle anderen Sitzungen dieses Kontos beenden?",
        ...
        "err.directory_down": "Die Anmeldung ist gerade nicht möglich: Das Benutzerverzeichnis ist nicht erreichbar. Bitte später erneut versuchen.",
        "err.pw_short": "Passwort zu kurz (min. {n})",
        "err.pw_long": "Passwort zu lang (max. {n})",
        "err.pw_weak": "Passwort zu leicht zu erraten (bekannt, trivial oder aus dem Kontonamen)",
        "err.username_required": "Benutzername nötig",
        "err.username_invalid": "Benutzername enthält unzulässige Zeichen",
        ...
        "magic.confirm_email_change": "Neue E-Mail-Adresse bestätigen",
        ...
        "acc.username_change": "Benutzernamen ändern",
        "acc.email": "E-Mail-Adresse",
        "acc.email_new": "Neue E-Mail-Adresse",
        "acc.email_change": "E-Mail-Adresse ändern",
        ...
        "acc.recovery_left": "{n} Recovery-Codes übrig",
        "acc.recovery_low": "Nur noch {n} Recovery-Codes — neue erzeugen",
        ...
        "admin.f.admin": "Admin",
        "admin.btn.owner_on": "Zum Owner machen",
        "admin.btn.owner_off": "Owner abgeben",
        "admin.confirm.owner_on": "Dieses Konto zum Owner machen? Owner lassen sich nicht löschen oder sperren.",
        "admin.confirm.owner_off": "Diesem Konto die Owner-Rolle nehmen?",
        "admin.f.service": "Service/Daemon",
        ...
        "admin.disabled_confirmation": "gesperrt (Bestätigung / App)",
