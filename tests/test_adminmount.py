...
def fresh(**cfg):
    ...
    a = TinySesam(TinySesamConfig(csrf_enabled=False, lang="de", db_path=db, passkey_enabled=False, oidc_enabled=False, cookie_secure=False, **cfg))
    a.ensure_admin("a", "pw")
    return a, db
